...
| Paywall | Медитации | AI Vibe |
|---------|-----------|---------|
| ![Paywall](screenshots/paywall.png) | ![Meditations](screenshots/meditations.png) | ![AI Vibe](screenshots/ai_vibe.png) |
...
Разработано в рамках учебного проекта MST.
...
Вопросы и предложения: [your.email@example.com](mailto:your.email@example.com)

---

<div align="center">

**ZenPulse** — найди свой внутренний покой 🌙
